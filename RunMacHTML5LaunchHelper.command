...
EPIC_MONO=""
if [ -f "D:\Unreal Engine 5\5.3_Mobile\UE_4.23\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "D:\Unreal Engine 5\5.3_Mobile\UE_4.23\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'D:\Unreal Engine 5\5.3_Mobile\UE_4.23\Engine\Build\BatchFiles\Mac\SetupMono.sh';
fi
